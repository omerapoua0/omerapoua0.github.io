(() => {
  ...
  document.querySelectorAll('.site-nav a').forEach(a=>{if(location.pathname.endsWith(a.getAttribute('href')))a.setAttribute('aria-current','page');a.addEventListener('click',closeMenu)});
